package com.yapp.moa.navigation.gifticon
...
import com.yapp.moa.gifticon.GifticonScreeen
import com.yapp.moa.gifticon.detail.GifticonDetailScreen
import com.yapp.moa.gifticon.edit.GifticonEditScreen
import com.yapp.moa.gifticon.nearestuse.NearestUseScreen
import com.yapp.moa.gifticon.register.GifticonRegisterScreen
...
fun NavGraphBuilder.gifticonGraph(
    ...
    navigation(
        ...
        composable(GifticonDestination.Gifticon.route) { entry ->
            val afterGifticonRegistrationCompletes = entry.savedStateHandle.get<Boolean>(
                KEY_AFTER_GIFTICON_REGISTRATION_COMPLETE
            )
        ...
        composable(GifticonDestination.Register.route) { entry ->
            val parentEntry = remember(entry) {
                navHostController.getBackStackEntry(
                    GifticonDestination.Gifticon.route
                )
            }
